    ...
    public function initialize(){
        ...
        if($this->setting['general']['clear_session']){
            ...
            $this->session->data['payment_address'] = array(
                ...
                'country_id' =>  $this->setSessionValue('country_id','payment_address', $data, $account, true),
                'zone_id' => $this->setSessionValue('zone_id','payment_address', $data, $account, true),
            ...
            $this->session->data['shipping_address'] = array(
                ...
                'country_id' => $this->setSessionValue('country_id','shipping_address', $data, $account, true),
                'zone_id' => $this->setSessionValue('zone_id','shipping_address', $data, $account, true),
