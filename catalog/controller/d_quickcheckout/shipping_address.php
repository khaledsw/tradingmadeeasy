...
class ControllerDQuickcheckoutShippingAddress extends Controller {
	...
	public function index($config){
        ...
        $json['shipping_address'] = array_map(function($field){ return htmlspecialchars_decode($field); }, $this->session->data['shipping_address']);
    ...
    public function prepare($json){
        ...
        $json['shipping_address'] = $this->session->data['shipping_address'];
	 $json['shipping_address'] = array_map(function($field){ return htmlspecialchars_decode($field); }, $json['shipping_address']);
        return $json;
    }
