...
class ControllerDQuickcheckoutPaymentAddress extends Controller {
    ...
    public function index($config){
        ...
        $json['payment_address'] = array_map(function($field){ return htmlspecialchars_decode($field); }, $this->session->data['payment_address']);
	...
	$json['payment_address'] = array_map(function($field){ return htmlspecialchars_decode($field); }, $json['payment_address']);
        return $json;
