<div id="cart" class="btn-group btn-block">
  <div class="heading">
  <button type="button" data-toggle="dropdown" data-loading-text="<?php echo $text_loading; ?>" class="btn btn-inverse btn-block dropdown-toggle"> <span id="cart-total"><?php echo $text_items; ?></span></button></div>
