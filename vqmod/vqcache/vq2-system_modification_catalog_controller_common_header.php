<?php
	...
	public function index() {
		...
		$data['title'] = $this->document->getTitle();
			...
			$this->document->addScript('catalog/view/javascript/webby_search.js');
			$this->document->addStyle('catalog/view/theme/default/stylesheet/webby_search.css');
...
if ($category['top'] == 3) continue; 
		...
		$data['search'] = $this->load->controller('common/search');
			...
			// MIT Minicart
			$minicart = $this->config->get('minicart');
			$this->load->model('tool/image');
			$data['is_minicart'] = 0;
			
			if($minicart && $minicart['status'] == 1) {

				$minicart_image_default = $this->model_tool_image->resize('mit/cart1.png', 64, 64);
				$data['minicart_image'] = $minicart_image_default;
				$data['is_minicart'] = 1;
				$data['cart1'] = $this->load->controller('common/cart1');
			}
			// MIT Minicart END
