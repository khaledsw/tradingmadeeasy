  ...
  <li id="sale"><a class="parent"><i class="fa fa-shopping-cart fa-fw"></i> <span><?php echo $text_sale; ?></span></a>
    <ul>
      <li><a href="<?php echo $order; ?>"><?php echo $text_order; ?></a></li>
				...
				<li><a style="color:#FF9900" href="<?php echo str_replace('order','qty_based_pricing_breakdown',$order); ?>">Qty Based Pricing Breakdown</a></li>
	  ...
	  <li><a href="<?php echo $abandoned_cart_reminder; ?>">Abandoned Cart Reminder Pro</a></li>
    </ul>
  </li>
