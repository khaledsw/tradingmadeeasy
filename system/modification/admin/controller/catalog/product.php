...
class ControllerCatalogProduct extends Controller {
	...
	public function autocomplete() {
		...
		'image'    => $result['image'] ? $this->model_tool_image->resize($result['image'], 40, 40) : $this->model_tool_image->resize('no_image.png', 40, 40),
		'quantity' => $result['quantity'],
		'status'   => $result['status'] ? $this->language->get('text_enabled') : $this->language->get('text_disabled'),
		'edit'     => $this->url->link('catalog/product/edit', 'token=' . $this->session->data['token'] . '&product_id=' . $result['product_id'] . '&filter_name=' . str_replace('%', '', $filter_name) . '&filter_model=' . $filter_model . '&limit=' . $limit . '&filter_status=' . $filter_status, 'SSL'),
