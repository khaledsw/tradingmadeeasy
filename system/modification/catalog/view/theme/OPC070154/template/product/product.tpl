		 ...
		 <div class="additional-carousel">	
		  ...
		  <div id="additional-carousel" class="image-additional <?php if ($imageCount >= $sliderFor){?>product-carousel<?php }?>">
			...
			<?php foreach ($images as $image) { ?>
				<div class="slider-item">
				<div class="product-block">		
        			<a href="<?php echo $image['popup']; ?>" title="<?php echo $heading_title; ?>" class="thumbnail elevatezoom-gallery" data-image="<?php echo $image['thumb']; ?>" data-zoom-image="<?php echo $image['popup']; ?>"><img id="cloud-zoom" src="<?php echo $image['thumb']; ?>" width="74" title="<?php echo $heading_title; ?>" alt="<?php echo $heading_title; ?>" /></a>
				</div>
				</div>		
	        <?php } ?>				
    	  </div>
    ...
    <?php } ?>
        ...
        <div class="<?php echo $class; ?>">
          ...
          <div id="product">
				...
				<?php echo $qty_based_pricing_breakdown;?>
          ...
          <ul class="list-unstyled price">
            ...
            <?php } ?>
		      ...
		      <div class="discount-collected" style="margin-top: 30px;">
			<?php if ($discounts) { ?>
          ...
          <?php } ?>
		    ...
		    <span class="links">
            <button type="button" data-toggle="tooltip" class="wishlist" title="<?php echo $button_wishlist; ?>" onclick="wishlist.add('<?php echo $product_id; ?>');"><i class="fa fa-heart"></i><?php echo $button_wishlist; ?></button>
            <button type="button" data-toggle="tooltip" class="compare" title="<?php echo $button_compare; ?>" onclick="compare.add('<?php echo $product_id; ?>');"><i class="fa fa-exchange"></i><?php echo $button_compare; ?></button>
          </span>
	...
	$.ajax({
		...
		success: function(json) {
			...
			if (json['success']) {
				...
				$('#cart > div > button').html('<span id="cart-total"> ' + json['total'] + '</span>');
				...
				// MINI CART
				$('#minicart').load('index.php?route=common/cart1/info');
...
//--></script>
				...
				<script type="text/javascript"> 
					$("#input-quantity").keyup(function () {
						$.ajax({
							url: 'index.php?route=product/product/changeliveprcbrkdown&product_id=<?php echo $product_id; ?>'+'&qty='+$("#input-quantity").val(),
							type: 'get', 
							success: function(dataresp) {
								$('h2.prices').html(dataresp); 
							}
						});
					});
					$( window ).load(function() {
					 	$.ajax({
							url: 'index.php?route=product/product/changeliveprcbrkdown&product_id=<?php echo $product_id; ?>'+'&qty=1',
							type: 'get', 
							success: function(dataresp) {
								if(dataresp != 'nothing') {
									$('h2.prices').html(dataresp); 
